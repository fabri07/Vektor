...
class AgentCEO(BaseAgent):
    ...
    async def classify_intent(
        ...
        system = (
            ...
            f"{_entity_guide}\n"
            "ENTIDAD domain (consulta_libre y pedir_consejo): cuando el intent sea "
            "`consulta_libre` o `pedir_consejo`, incluí `domain` en entities con el dominio "
            "de la pregunta. Valores válidos: clientes, ventas, gastos, stock, proveedores, "
            "caja, marketing. Si no podés inferir el dominio con confianza, OMITILO — no "
            "adivines; se le va a preguntar al usuario.\n"
