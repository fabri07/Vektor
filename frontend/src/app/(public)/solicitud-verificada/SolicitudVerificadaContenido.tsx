  ...
  return (
    <div className="space-y-6 text-center">
      ...
      <div>
        ...
        {/*
          Qué pasa si la respuesta es que no. Decirlo acá —y no dejarlo para el
          mail— es lo que convierte la espera en una espera con final conocido:
          el visitante ya nos dio trece respuestas sobre su negocio y merece
          saber que ninguna rama termina en silencio.
        */}
        <p className="mt-3 text-sm text-vk-text-muted">
          Si por ahora no podemos ayudarte, también te lo decimos por mail y te
          explicamos por qué. En cualquier caso vas a tener una respuesta: no
          quedan solicitudes sin contestar.
        </p>
      </div>
