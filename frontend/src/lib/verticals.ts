...
export const VERTICAL_OPTIONS: readonly VerticalOption[] = [
  ...
  },
  {
    ...
    description: "Útiles, mochilas, libros y regalería, con pico en la zafra escolar.",
    Icon: IconLibreria,
    anchor: "libreria",
  },
  {
    code: "indumentaria",
    name: "Indumentaria",
    description: "Ropa y calzado por temporada, con curva de talles y colores.",
  ...
  },
  {
    ...
    description: "Frutas y verduras del mercado, con rotación de días.",
    Icon: IconVerduleria,
    anchor: "verduleria",
  },
] as const;
