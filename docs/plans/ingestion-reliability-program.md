...
- Publicar el trabajo de parsing después de confirmar la existencia del archivo. Si falla la publicación, persistir un estado recuperable y ofrecer reintento; F5 cerrará la ventana entre commit y publicación mediante una cola persistida en la base.
...
- Reintentar solo errores transitorios de red/servicios, con espera creciente y límite. Los errores permanentes de formato o validación deben tener una salida clara. No agregar reintentos antes de proteger las ejecuciones duplicadas.
